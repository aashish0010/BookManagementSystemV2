        ...
        public static string EmailHelper(string CompanyName, string Otp, string UserName)
        {
            return @"<!DOCTYPE HTML PUBLIC ""-//W3C//DTD XHTML 1.0 Transitional //EN"" ""http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"">
                ...
                * {
                ...
                <p style=""font-size: 14px; line-height: 140%;"">&nbsp;</p>
                <p style=""font-size: 14px; line-height: 140%;""><span style=""font-size: 18px; line-height: 25.2px; color: #666666;"">To reset your password, please follow the OTP below: </span></p>
                  </div>
                ...
                <p style=""font-size: 14px; line-height: 140%;""><span style=""font-size: 14px; line-height: 19.6px; color: #ecf0f1;"">" + CompanyName + @"</span></p>
                  </div>
